...
class MvtBonsValide
{
    ...
    public function getCreatedAt(): ?\DateTimeImmutable
    {
        ...
        // Nettoyer les nanosecondes Oracle
        $clean = preg_replace('/,\d+$/', '', $this->createdAt);

        $date = \DateTimeImmutable::createFromFormat('d/m/y H:i:s', $clean);
    ...
    public function getUpdatedAt(): ?\DateTimeImmutable
    {
        ...
        $clean = preg_replace('/,\d+$/', '', $this->updatedAt);
    ...
    public function getDeletedAt(): ?\DateTimeImmutable
    {
        ...
        $date = \DateTimeImmutable::createFromFormat('Y-m-d H:i:s', $this->deletedAt);
